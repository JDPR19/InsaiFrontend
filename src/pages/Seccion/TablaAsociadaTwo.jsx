        ...
        <div className='mainContainer'>
            ...
            <div className='tableSection'>
                <div className='filtersContainer'>
                    ...
                    >
                        <img src={icon.pdf4} alt="Exportar" title='Exportar Datos En PDF' className='iconTwo' />
                        Exportar
                    </button>
                    ...
                    className='btn-estandar'
                    >
                        <img src={icon.excel} alt="Exportar" title='Exportar Datos En Excel' className='iconTwo' />
                        Exportar
                    </button>
                                ...
                                <td>
                                    <div className='iconContainer'>
                                        <img
                                            src={icon.pdf2}
                                            className='iconver'
                                            title='Descargar Ficha de Productor'
                                        />
                                        <img
