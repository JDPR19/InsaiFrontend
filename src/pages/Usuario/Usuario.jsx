    ...
    return (
        <div className='mainContainer'>
            ...
            {/*/////////////////// Tabla ///////////*/}
                ...
                >
                    <img src={icon.user} alt="" className='iconTwo'/>
                    <h1 className='title' title='Usuarios'>Resumen de Usuarios</h1>
                
                {/* Ayudante informativo de Pantalla */}
                    <div >
                        <AyudaTooltip descripcion="En esta sección puedes visualizar, registrar y gestionar todos los usuarios creados. Usa los filtros, la búsqueda y las opciones de exportación para organizar y consultar la información de manera eficiente." />
                    </div>
                </div>
