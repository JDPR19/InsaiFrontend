        ...
        <div className='mainContainer'>
            ...
            {/*/////////////////// Tabla ///////////*/}
                ...
                >
                    ...
                    <h1 className='title' title='Tipos de plaga'>Resumen de Tipos de Plaga</h1>
                
                {/* Ayudante informativo de Pantalla */}
                    <div >
                        <AyudaTooltip descripcion="En esta sección puedes visualizar, registrar y gestionar todos los tipos de plaga. Usa los filtros, la búsqueda y las opciones de exportación para organizar y consultar la información de manera eficiente." />
                    </div>
                </div>
            ...
            <div className='tableSection'>
                <div className='filtersContainer'>
                     {tienePermiso('tipo_plaga', 'crear') && (<button 
                        type='button'
                        onClick={openModal} 
                        className='create'
                            ...
                            <tr key={tipo_plaga.id} >
                                ...
                                <td>
                                    <div className='iconContainer'>
                                        {tienePermiso('tipo_plaga', 'editar') && (<img
                                        ...
                                        {tienePermiso('tipo_plaga', 'eliminar') && (<img 
